...
class NutritionStatusFlowDelegate extends ChangeNotifier
    implements FlowStepDelegate {
  NutritionStatusFlowDelegate({required this.backable, required this.flowData});
  ...
  Future<void> load() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
          'http://10.0.2.2:3000/api/screening/${flowData.screeningId}/nutrition-status',
        ),
